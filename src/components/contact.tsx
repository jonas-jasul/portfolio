            ...
            <div className='flex flex-col lg:flex-row-reverse'>
                <div className="contact-div w-full h-[30vh] lg:w-1/3 lg:h-[80vh]">
                    <div className="contact-heading-div h-full flex flex-col justify-center items-center">
                        ...
                        <div className='phone flex flex-row justify-center items-center contact-text'><AiOutlinePhone className='mx-2' size={'1.6em'} /> <h3 className='text-2xl'>+370 605 21032</h3> </div>
                    </div>
